...
class QM_AdvancedFeedback_Block_Adminhtml_Consultation_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('qmadvfeedback/consultation')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('email', array(
            'header'=> Mage::helper('qmadvfeedback')->__('Email'),
            'index' => 'email',
            'type'=> 'text',
