...
class QM_AdvancedFeedback_Helper_Data extends Mage_Core_Helper_Abstract
{
    const REFERER_QUERY_PARAM_NAME = 'referer';
    const PHONE_MASK = 'qmadvfeedback/global_settings/phone_mask';
    ...
    {
        return Mage::getStoreConfig(self::PHONE_MASK);
    }
}
