...
class QM_Checkout_Block_Block extends Mage_Checkout_Block_Onepage_Abstract
{
    protected
        /**
         * Messages block
    ...
    {
        $this->setTemplate('qm/checkout/block.phtml');
    }
    ...
    {
        return $this->getUrl('qm_order/checkout/login');
    }
