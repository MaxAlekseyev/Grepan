...
class QM_Checkout_Model_Resource_Countries extends Mage_Directory_Model_Mysql4_Country_Collection
{
    protected
        /**
     ...
     *
     * @return QM_Checkout_Model_Resource_Countries
     */
    ...
    public function getCountryCodeByName($countryName)
    {
        ...
        if (isset($countries[$countryName])) {
            ...
            return Mage::helper('qmcheckout')->getDefaultCountryId();
        }
    }
    ...
    {
        return Mage::helper('qmcheckout')->lowerCase($string);
    }
}
