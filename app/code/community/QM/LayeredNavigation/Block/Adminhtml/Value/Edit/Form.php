<?php
class QM_LayeredNavigation_Block_Adminhtml_Value_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $model = Mage::registry('qm_layerednavigation_value');
    ...
    private function getImageHtml($img)
    {
        ...
        if ($img){
            ...
            $html .= '<img src="'.Mage::getBaseUrl('media') . 'layerednavigation/' . $img .'" />';
            $html .= '</p>';
        } 
        return $html;     
    }
