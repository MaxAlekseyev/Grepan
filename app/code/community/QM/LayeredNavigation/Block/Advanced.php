<?php
class QM_LayeredNavigation_Block_Advanced extends Mage_Catalog_Block_Navigation
{
    public function drawOpenCategoryItem($category, $level = 0)
    {
        ...
        $showAll   = Mage::getStoreConfig('qm_layerednavigation/advanced_categories/show_all_categories');
        $showDepth = Mage::getStoreConfig('qm_layerednavigation/advanced_categories/show_all_categories_depth');
    ...
    public function getCategories()
    {
        ...
        $startFrom = Mage::getStoreConfig('qm_layerednavigation/advanced_categories/start_category');
        
        switch($startFrom) {            
            case QM_LayeredNavigation_Model_Source_Category_Start::START_CHILDREN:
                break;
            case QM_LayeredNavigation_Model_Source_Category_Start::START_CURRENT:
                if ($parent) {
                    $parent = $parent->getParentCategory();
                }
                break;
            case QM_LayeredNavigation_Model_Source_Category_Start::START_ROOT:
    ...
    {
        return Mage::getStoreConfigFlag('qm_layerednavigation/advanced_categories/display_product_count');
    }
    ...
    protected function _toHtml()
    {
        ...
        $exclude = Mage::getStoreConfig('qm_layerednavigation/general/exclude_cat');
        if ($exclude){
