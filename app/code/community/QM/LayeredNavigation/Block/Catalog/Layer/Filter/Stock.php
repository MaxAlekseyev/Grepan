<?php
class QM_LayeredNavigation_Block_Catalog_Layer_Filter_Stock extends Mage_Catalog_Block_Layer_Filter_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('qm/layerednavigation/attribute.phtml');
        $this->_filterModelName = 'qm_layerednavigation/catalog_layer_filter_stock';
    }
    ...
    {
    	return Mage::getStoreConfig('qm_layerednavigation/general/stock_filter_pos');
    }
