<?php
class QM_LayeredNavigation_Helper_Image extends Mage_Catalog_Helper_Image
{
    public function setProduct($product)
    {
        $configurableCodes = Mage::getStoreConfig('qm_layerednavigation/general/configurable_images');
