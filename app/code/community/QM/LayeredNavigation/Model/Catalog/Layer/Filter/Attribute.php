<?php
class QM_LayeredNavigation_Model_Catalog_Layer_Filter_Attribute extends Mage_Catalog_Model_Layer_Filter_Attribute
{
    ...
    {
        $currentVals = Mage::helper('qm_layerednavigation')->getRequestValues($this->_requestVar);
        if ($currentVals) {
            ...
            $attribute = $this->getAttributeModel();      
            $text = '';
            $options = Mage::helper('qm_layerednavigation/attributes')->getAttributeOptions($attribute->getAttributeCode());
