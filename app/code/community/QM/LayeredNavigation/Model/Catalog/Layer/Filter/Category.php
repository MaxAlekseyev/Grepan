<?php
class QM_LayeredNavigation_Model_Catalog_Layer_Filter_Category extends Mage_Catalog_Model_Layer_Filter_Category
{
    /**
     * Display Types
     */
    ...
    protected function _getItemsData()
    {
        ...
        $_displayType = Mage::getStoreConfig('qm_layerednavigation/general/categories_type');
    ...
    protected function _prepareItemData($category, $id, $isSelected, $level = 1, $isFolded = false, $skipCount = false)
    {
        ...
        if ($category->getIsActive() && ($skipCount || $category->getProductCount())) {
            $row = array(
                ...
                'value'       => Mage::helper('qm_layerednavigation/url')->getCategoryUrl($category),
