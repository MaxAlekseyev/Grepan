...
class QM_LayeredNavigation_Model_Catalog_Layer_Filter_Decimal extends Mage_Catalog_Model_Layer_Filter_Decimal
{
    ...
    public function getSettings()
    {
        if (is_null($this->settings)){
            $this->settings = Mage::getResourceModel('qm_layerednavigation/filter')
    ...
    protected function _getResource()
    {
        if (is_null($this->_resource)) {
            $this->_resource = Mage::getModel('qm_layerednavigation/mysql4_decimal');
        }
