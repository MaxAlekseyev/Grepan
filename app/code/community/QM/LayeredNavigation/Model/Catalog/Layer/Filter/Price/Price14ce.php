<?php
class QM_LayeredNavigation_Model_Catalog_Layer_Filter_Price_Price14ce extends Mage_Catalog_Model_Layer_Filter_Price
{
        ...
        if (is_null($this->_resource)) {
            if (Mage::helper('qm_layerednavigation')->isVersionLessThan(1, 4)){
                ...
                if ($this->getRequestVar() != 'price'){
                    ...
                    $this->_resource = Mage::getSingleton('qm_layerednavigation/mysql4_price13');
                }
                ...
                $this->_resource = Mage::getModel('qm_layerednavigation/mysql4_price');
            }
        }
    ...
    {
        if ($this->getRequestVar() != 'price' && Mage::helper('qm_layerednavigation')->isVersionLessThan(1, 4)){
            return parent::_getItemsData(); 
        }
        
        if (!Mage::getStoreConfig('qm_layerednavigation/general/use_custom_ranges')){
            return parent::_getItemsData();
        }
    ...
    public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
    {
        ...
        $filterBlock->setValueFrom(Mage::helper('qm_layerednavigation')->__('From'));
        $filterBlock->setValueTo(Mage::helper('qm_layerednavigation')->__('To'));
