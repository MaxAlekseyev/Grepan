<?php
class QM_LayeredNavigation_Model_Catalog_Layer_Filter_Price_Price17ce extends Mage_Catalog_Model_Layer_Filter_Price
{
    ...
    protected function _getResource()
    {
        if (is_null($this->_resource)) {
            $this->_resource = Mage::getSingleton('qm_layerednavigation/mysql4_price17');
        }
