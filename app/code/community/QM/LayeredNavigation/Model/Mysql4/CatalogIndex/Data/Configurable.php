<?php
class QM_LayeredNavigation_Model_Mysql4_CatalogIndex_Data_Configurable extends Mage_CatalogIndex_Model_Mysql4_Data_Configurable
{
    public function fetchLinkInformation($store, $table, $idField, $whereField, $id, $additionalWheres = array()) 
    {
        ...
        $showInStockOnly = Mage::getStoreConfig('qm_layerednavigation/general/show_in_stock', $store);
