<?php
class QM_LayeredNavigation_Model_Mysql4_Decimal extends Mage_Catalog_Model_Resource_Eav_Mysql4_Layer_Filter_Decimal
{
    /**
    ...
    public function applyFilterToCollection($filter, $from, $to)
    {
        ...
        if (Mage::getStoreConfig('qm_layerednavigation/general/bundle')){
