...
$tableCity = $installer->getConnection()
    ...
    ->addColumn('description', Varien_Db_Ddl_Table::TYPE_VARCHAR, 1255, array(
        'nullable' => true,
    ))
    ->addColumn('description_ru', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
        'nullable' => true,
    ))
    ->addColumn('ref', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
        'nullable' => false,
    ))
    ->addColumn('area', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
        'nullable' => false,
    ));
...
$tableArea = $installer->getConnection()
    ...
    ->addColumn('areas_center', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
        'nullable' => true,
    ));
...
$tableStreet = $installer->getConnection()
    ...
    ->addColumn('city_id', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
        'nullable' => false,
    ))
    ->addColumn('ref', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
        'nullable' => false,
    ))
    ->addColumn('streets_type_ref', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
        'nullable' => false,
    ))
    ->addColumn('streets_type', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
        'nullable' => true,
    ));
