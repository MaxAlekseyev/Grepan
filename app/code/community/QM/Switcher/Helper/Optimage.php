...
class QM_Switcher_Helper_Optimage extends QM_Switcher_Helper_Data
{
     /**
     * config path to transform dropdowns
     */
    const XML_TRANSFORM_PATH   = 'qm_switcher/settings/transform_dropdowns';

    /**
     * config path to color attributes
     */
    const XML_USE_OPTION_IMAGES_PATH= 'qm_switcher/settings/use_option_images';

    /*  IMAGE RESIZE HELPER */

    //image placeholder @var string, located in skin directory
    protected $_placeholder = '/images/qm_switcher/no-optimage.gif';
    protected $_subdir      = 'qm/optimages';
     ...
     *
     * @param bool $value
     * @return bool|QM_Switcher_Helper_Optimage
     */
     ...
     *
     * @param int $value
     * @return int|QM_Switcher_Helper_Optimage
     */
     ...
     *
     * @param array $value
     * @return array|QM_Switcher_Helper_Optimage
     */
