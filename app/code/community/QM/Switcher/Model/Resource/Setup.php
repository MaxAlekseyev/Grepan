...
class QM_Switcher_Model_Resource_Setup extends Mage_Catalog_Model_Resource_Setup
{
    /**
     * @var array
     */
    ...
    protected $_pathsToCheck = array(
        'qm_switcher/settings/transform_dropdowns',
        'qm_switcher/settings/transform_specific',
        'qm_switcher/settings/use_option_images',
        'qm_switcher/settings/use_images',
        'qm_switcher/settings/image_attribute'
    );
    ...
    {
        $path = 'qm_switcher/settings/transform_dropdowns';
        ...
        $toTransform = array();
        if ($howToTransform == 2) {
            $specificPath = 'qm_switcher/settings/transform_specific';
    ...
    public function getUseOptionImages($scope)
    {
        ...
        $path = 'qm_switcher/settings/use_option_images';
        ...
        $usedImages = array();
        /** @var QM_Switcher_Helper_Optimage $optImageHelper */
        $optImageHelper = Mage::helper('qm_switcher/optimage');
    ...
    {
        $path = 'qm_switcher/settings/use_images';
    ...
    public function getUsesColors()
    {
        if (is_null($this->_usesColors)) {
            ...
            $table = $this->getTable('qm_switcher/hashcode');
            $q = "SELECT * FROM {$table}";
