...
class QM_QMExtPdfDocs_Model_Order_Pdf_Items_Invoice_ShipmentItem extends Mage_Sales_Model_Order_Pdf_Items_Invoice_Default
{
    /**
     * Draw item line
     **/
    public function draw()
    {
        ...
        $pdf    = $this->getPdf();
        $page   = $this->getPage();
        $itemsTotal = ($item->getQty()*1)*$item->getPrice();
        $lines  = array();
